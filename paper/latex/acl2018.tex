...
\maketitle
\begin{abstract}
  In this paper we focus on computing semantic relatedness get an approximation to human judgement.
  We use the Knowledge Graph(DBpedia) which derived from wikipedia as the background knowledge.
  ...
  The experiments based on golded dataset for computing semantic relatedness show
